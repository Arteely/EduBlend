...
export default function StudentBar() {
    ...
    const DatePicker = () => {
        useScript('https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.3.0/datepicker.min.js');
        return (
            <div inline-datepicker datepicker-autoselect-today class="mx-auto sm:mx-0 flex justify-center my-5 [&>div>div]:shadow-none [&>div>div]:bg-light-purple [&_div>button]:bg-light-purple"></div>
        );
    };
      ...
      <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white dark:bg-gray-900">
        ...
        <div class="relative">
          ...
          <input
            ...
            class="block p-2 ps-10 text-sm text-gray-900 border border-purple rounded-lg w-80 bg-white focus:ring-purple focus:border-purple"
